const hairstyles = [
    ...
    },
    {
        ...
        name: '쉐도우펌',
        category: 'men-perm',
        description: '남자펌 스타일의 정석 부드러운 이미지의 스타일',
    ...
    },
    {
        ...
        name: '필러스컷 + 볼륨매직',
        category: 'men-medium',
        description: '부드러운 남성미가 돋보이는 스타일',
        imageUrl: 'images/style8.jpg'
    },
    // 추가 셋팅 (9-30)
    { id: 9, name: '슬릭세미울프컷', category: 'men-long', description: '가벼운 텍스쳐의 시크함과 유니크함이 돋보이는 스타일', imageUrl: 'images/style9.jpg' },
    { id: 10, name: '슬릭컷+다운펌', category: 'men-medium', description: '시크함과 트랜디함의 정석 스타일', imageUrl: 'images/style10.jpg' },
    { id: 11, name: '테일펌', category: 'men-perm', description: '부드러운 이미지와 자유분방한 텍스처를<br>함께 즐길 수 있는 남성 스타일', imageUrl: 'images/style11.jpg' },
    { id: 12, name: '쉐도우펌', category: 'men-perm', description: '자연스러운 볼륨, 유니크한 텍스쳐의 스타일', imageUrl: 'images/style12.jpg' },
    { id: 13, name: '시스루쉐도우펌', category: 'men-perm', description: '볼륨과 가벼움을 한번에 즐길 수 있는 스타일', imageUrl: 'images/style13.jpg' },
